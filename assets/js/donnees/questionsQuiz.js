...
export let questions = [
  ...
  {
    question: "Quel est le titre du premier roman canadien-français?",
    reponses:  ["Les anciens canadiens", "L'influence d'un livre", "Un Homme et sa Patate"],
    bonneReponse: "L'influence d'un livre",    
  },
  {
  ...
  },
  {
    ...
    reponses: ["Capitale-Nationale", "Laurentides", "Estrie"],
    bonneReponse: "Laurentides",
  },
];

export let messages = {
  bonneReponse: "Bonne réponse! 👏",
  mauvaiseReponse: "Incorrecte! 😫",
  finQuiz: "Merci d'avoir participé au quiz! 🏆",
};

/* ==== SOURCES: 
https://www.babelio.com/quiz/3592/Litterature-quebecoise
https://www.babelio.com/quiz/4596/Litterature-quebecoise */
